...
// .wrangler/tmp/bundle-M42mnj/checked-fetch.js
...
var AcscEngine = class {
  static {
    __name(this, "AcscEngine");
  }
  __destroy_into_raw() {
    const ptr = this.__wbg_ptr;
    this.__wbg_ptr = 0;
    AcscEngineFinalization.unregister(this);
    return ptr;
  }
  free() {
    const ptr = this.__destroy_into_raw();
    wasm.__wbg_acscengine_free(ptr, 0);
  }
  /**
   * Compresses a batch of JSON operations into a single semantic state.
   * ACSC reduces O(N) ops into O(1) state representation.
   * @param {string} json_batch
   * @returns {string}
   */
  static compress_batch(json_batch) {
    let deferred2_0;
    let deferred2_1;
    try {
      const ptr0 = passStringToWasm0(json_batch, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
      const len0 = WASM_VECTOR_LEN;
      const ret = wasm.acscengine_compress_batch(ptr0, len0);
      deferred2_0 = ret[0];
      deferred2_1 = ret[1];
...
if (Symbol.dispose) AcscEngine.prototype[Symbol.dispose] = AcscEngine.prototype.free;
var ActEngine = class {
  static {
    __name(this, "ActEngine");
  }
  __destroy_into_raw() {
    const ptr = this.__wbg_ptr;
    this.__wbg_ptr = 0;
    ActEngineFinalization.unregister(this);
    return ptr;
  }
  free() {
    const ptr = this.__destroy_into_raw();
    wasm.__wbg_actengine_free(ptr, 0);
  }
  /**
   * Computes contention score: C = αv + βq + γσ
   * @param {number} velocity
   * @param {number} queue_depth
   * @param {number} variance
   * @returns {number}
   */
  static calculate_score(velocity, queue_depth, variance) {
    const ret = wasm.actengine_calculate_score(velocity, queue_depth, variance);
    return ret;
  }
  /**
   * @param {number} score
  ...
  static classify(score) {
    ...
    let deferred1_1;
    try {
      const ret = wasm.actengine_classify(score);
      deferred1_0 = ret[0];
      deferred1_1 = ret[1];
      return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
if (Symbol.dispose) ActEngine.prototype[Symbol.dispose] = ActEngine.prototype.free;
var AensEngine = class {
  static {
    __name(this, "AensEngine");
  }
  __destroy_into_raw() {
    const ptr = this.__wbg_ptr;
    this.__wbg_ptr = 0;
    AensEngineFinalization.unregister(this);
    return ptr;
  }
  free() {
    const ptr = this.__destroy_into_raw();
    wasm.__wbg_aensengine_free(ptr, 0);
  }
  /**
   ...
   * @returns {number}
   */
  static calculate_adaptive_ttl(access_count) {
    const ret = wasm.aensengine_calculate_adaptive_ttl(access_count);
    return ret >>> 0;
  }
  /**
   ...
   * @param {number} velocity
   * @param {number} current_threshold
   * @returns {number}
   */
  static calculate_stability_index(velocity, current_threshold) {
    const ret = wasm.aensengine_calculate_stability_index(velocity, current_threshold);
    return ret;
  }
  /**
   ...
   * @param {number} velocity
   * @param {number} predictability
   * @param {number} queue_depth
   * @param {number} base_window
   * @returns {number}
   */
  static calculate_threshold(velocity, predictability, queue_depth, base_window) {
    const ret = wasm.aensengine_calculate_threshold(velocity, predictability, queue_depth, base_window);
    return ret;
  }
};
if (Symbol.dispose) AensEngine.prototype[Symbol.dispose] = AensEngine.prototype.free;
var BloomFilter = class _BloomFilter {
  ...
  static __wrap(ptr) {
    ptr = ptr >>> 0;
    const obj = Object.create(_BloomFilter.prototype);
    obj.__wbg_ptr = ptr;
   ...
   * @param {number} size
   * @param {number} hash_count
   * @returns {BloomFilter}
   */
  static from_state(bits, size, hash_count) {
    const ptr0 = passArray8ToWasm0(bits, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.bloomfilter_from_state(ptr0, len0, size, hash_count);
    return _BloomFilter.__wrap(ret);
  }
  /**
   * @returns {Uint8Array}
   */
  get_bits() {
    const ret = wasm.bloomfilter_get_bits(this.__wbg_ptr);
   ...
   */
  get_hash_count() {
    const ret = wasm.bloomfilter_get_hash_count(this.__wbg_ptr);
    return ret >>> 0;
  }
  /**
   * @returns {number}
   */
  get_size() {
    const ret = wasm.bloomfilter_get_size(this.__wbg_ptr);
    return ret >>> 0;
  }
  /**
   * @param {string} key
...
var PvcEngine = class {
  static {
    __name(this, "PvcEngine");
  }
  __destroy_into_raw() {
    const ptr = this.__wbg_ptr;
    this.__wbg_ptr = 0;
    PvcEngineFinalization.unregister(this);
    return ptr;
  }
  free() {
    const ptr = this.__destroy_into_raw();
    wasm.__wbg_pvcengine_free(ptr, 0);
  }
  /**
   ...
   * @returns {number}
   */
  static get_path_signature(json_content) {
    const ptr0 = passStringToWasm0(json_content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.pvcengine_get_path_signature(ptr0, len0);
    return ret >>> 0;
  }
  /**
   ...
   * @param {string} buffer_json
   * @param {string} new_patch_json
   * @returns {boolean}
   */
  static has_path_conflict(buffer_json, new_patch_json) {
    const ptr0 = passStringToWasm0(buffer_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(new_patch_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.pvcengine_has_path_conflict(ptr0, len0, ptr1, len1);
    return ret !== 0;
  }
};
if (Symbol.dispose) PvcEngine.prototype[Symbol.dispose] = PvcEngine.prototype.free;
var SecurityEvaluator = class {
  static {
   ...
   * @returns {boolean}
   */
  static can_access_at_depth(rule, context_json, current_depth, max_depth) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.securityevaluator_can_access_at_depth(ptr0, len0, ptr1, len1, current_depth, max_depth);
    return ret !== 0;
  }
  /**
...
function __wbg_get_imports() {
  const import0 = {
    __proto__: null,
    __wbg___wbindgen_throw_89ca9e2c67795ec1: /* @__PURE__ */ __name(function(arg0, arg1) {
      throw new Error(getStringFromWasm0(arg0, arg1));
    }, "__wbg___wbindgen_throw_89ca9e2c67795ec1"),
...
var AcscEngineFinalization = typeof FinalizationRegistry === "undefined" ? { register: /* @__PURE__ */ __name(() => {
}, "register"), unregister: /* @__PURE__ */ __name(() => {
}, "unregister") } : new FinalizationRegistry((ptr) => wasm.__wbg_acscengine_free(ptr >>> 0, 1));
var ActEngineFinalization = typeof FinalizationRegistry === "undefined" ? { register: /* @__PURE__ */ __name(() => {
}, "register"), unregister: /* @__PURE__ */ __name(() => {
}, "unregister") } : new FinalizationRegistry((ptr) => wasm.__wbg_actengine_free(ptr >>> 0, 1));
var AensEngineFinalization = typeof FinalizationRegistry === "undefined" ? { register: /* @__PURE__ */ __name(() => {
}, "register"), unregister: /* @__PURE__ */ __name(() => {
}, "unregister") } : new FinalizationRegistry((ptr) => wasm.__wbg_aensengine_free(ptr >>> 0, 1));
var BloomFilterFinalization = typeof FinalizationRegistry === "undefined" ? { register: /* @__PURE__ */ __name(() => {
}, "register"), unregister: /* @__PURE__ */ __name(() => {
}, "unregister") } : new FinalizationRegistry((ptr) => wasm.__wbg_bloomfilter_free(ptr >>> 0, 1));
var CrdtEngineFinalization = typeof FinalizationRegistry === "undefined" ? { register: /* @__PURE__ */ __name(() => {
}, "register"), unregister: /* @__PURE__ */ __name(() => {
}, "unregister") } : new FinalizationRegistry((ptr) => wasm.__wbg_crdtengine_free(ptr >>> 0, 1));
var PvcEngineFinalization = typeof FinalizationRegistry === "undefined" ? { register: /* @__PURE__ */ __name(() => {
}, "register"), unregister: /* @__PURE__ */ __name(() => {
}, "unregister") } : new FinalizationRegistry((ptr) => wasm.__wbg_pvcengine_free(ptr >>> 0, 1));
var SecurityEvaluatorFinalization = typeof FinalizationRegistry === "undefined" ? { register: /* @__PURE__ */ __name(() => {
}, "register"), unregister: /* @__PURE__ */ __name(() => {
...
// src/security-engine.ts
import wasmModule2 from "./2cb00a6fec7389cdd485ce4f70d20924b5937228-wasm_engine_bg.wasm";
var SecurityEngine = class {
  static {
    __name(this, "SecurityEngine");
  }
  rules;
  ...
  constructor(rulesJson) {
    ...
    this.wasmInitPromise = __wbg_init(wasmModule2).then(() => {
      this.wasmReady = true;
    });
  }
  async canRead(path, auth) {
  ...
  async evaluate(op, path, auth, data) {
    if (!this.wasmReady) await this.wasmInitPromise;
...
// src/write-buffer.ts
import wasmModule4 from "./2cb00a6fec7389cdd485ce4f70d20924b5937228-wasm_engine_bg.wasm";

// src/cache.ts
import wasmModule3 from "./2cb00a6fec7389cdd485ce4f70d20924b5937228-wasm_engine_bg.wasm";
var PredictiveCache = class _PredictiveCache {
  constructor(env) {
    ...
    if (!_PredictiveCache.bloom && !_PredictiveCache.bloomInitPromise) {
      _PredictiveCache.bloomInitPromise = (async () => {
        await __wbg_init(wasmModule3);
  ...
  static bloom = null;
  static bloomInitPromise = null;
  // Adaptive TTL tracking
  static accessCount = /* @__PURE__ */ new Map();
  static lastReset = Date.now();
  static pendingPromises = /* @__PURE__ */ new Map();
  async initBloomInternal() {
    try {
      const meta = await this.env.PROJECT_CACHE.get("system:bloom:meta", { type: "json" });
      const bitsBuffer = await this.env.PROJECT_CACHE.get("system:bloom:bits", { type: "arrayBuffer" });
      if (meta && bitsBuffer) {
        _PredictiveCache.bloom = BloomFilter.from_state(new Uint8Array(bitsBuffer), meta.size, meta.hashCount);
        console.log("\u2705 Bloom Filter restored from KV");
      } else {
        _PredictiveCache.bloom = new BloomFilter(1e6, 0.01);
      }
    } catch (e) {
  ...
  async persistBloom(ctx) {
    if (!_PredictiveCache.bloom) return;
    const persist = /* @__PURE__ */ __name(async () => {
      try {
        const bits = _PredictiveCache.bloom.get_bits();
        const meta = {
          size: _PredictiveCache.bloom.get_size(),
          hash_count: _PredictiveCache.bloom.get_hash_count(),
          timestamp: Date.now()
        };
        await this.env.PROJECT_CACHE.put("system:bloom:bits", bits.buffer.slice(0));
  ...
  async get(key, fetcher) {
    if (!_PredictiveCache.bloom && _PredictiveCache.bloomInitPromise) {
      await _PredictiveCache.bloomInitPromise;
    }
    if (_PredictiveCache.bloom && !_PredictiveCache.bloom.has(key)) {
    ...
    if (mem && mem.expiry > now) {
      if (typeof globalThis.recordHit === "function") globalThis.recordHit();
      return mem.data;
    }
    if (_PredictiveCache.pendingPromises.has(key)) {
      console.log(`[CACHE COALESCE] Sharing promise for: ${key}`);
      return await _PredictiveCache.pendingPromises.get(key);
    }
    const workPromise = (async () => {
      try {
        ...
        if (data) {
          ...
          if (typeof globalThis.recordMiss === "function") globalThis.recordMiss();
        }
        if (!data && fetcher) {
        ...
        if (data) {
          ...
          _PredictiveCache.memCache.set(key, { data, expiry: Date.now() + ttl * 1e3 });
        }
        return data;
      } catch (e) {
        return null;
      } finally {
        _PredictiveCache.pendingPromises.delete(key);
      }
    })();
    _PredictiveCache.pendingPromises.set(key, workPromise);
  ...
  async set(key, value, explicitTtl) {
    ...
    try {
      ...
      if (currentCount > 100 && _PredictiveCache.bloom) {
        const heatKey = `system:heat:${key}`;
        _PredictiveCache.bloom.add(heatKey);
      }
      if (Math.random() < 0.1) {
...
// src/write-buffer.ts
var WriteBuffer = class _WriteBuffer {
  constructor(env) {
    this.env = env;
    if (!_WriteBuffer.wasmInitPromise) {
      _WriteBuffer.wasmInitPromise = __wbg_init(wasmModule4).then(() => {
      });
    }
  }
  static {
  ...
  static velocityTracker = /* @__PURE__ */ new Map();
  static varianceTracker = /* @__PURE__ */ new Map();
  static lastSampleTime = Date.now();
  static currentTopology = /* @__PURE__ */ new Map();
  ...
  static getTopology(workspace, path) {
    return _WriteBuffer.currentTopology.get(`${workspace}:${path}`) || "COLD";
  }
  static getMetrics() {
    return _WriteBuffer.metrics;
  }
  static getInstance(env) {
    if (!_WriteBuffer.instance) {
      _WriteBuffer.instance = new _WriteBuffer(env);
    }
    return _WriteBuffer.instance;
  }
  async queueWrite(op, ctx) {
    if (_WriteBuffer.wasmInitPromise) await _WriteBuffer.wasmInitPromise;
    _WriteBuffer.buffer.push(op);
    const now = Date.now();
    const docKey = `${op.workspace}:${op.path}`;
    const currentRate = (_WriteBuffer.velocityTracker.get(docKey) || 0) + 1;
    _WriteBuffer.velocityTracker.set(docKey, currentRate);
    if (now - _WriteBuffer.lastSampleTime > 1e3) {
      _WriteBuffer.velocityTracker.clear();
      _WriteBuffer.lastSampleTime = now;
    }
    const velocity = Math.max(1, currentRate);
    const times = _WriteBuffer.varianceTracker.get(docKey) || [];
    times.push(now);
    if (times.length > 20) times.shift();
    _WriteBuffer.varianceTracker.set(docKey, times);
    let variance = 0;
    if (times.length > 1) {
    ...
    const actScore = ActEngine.calculate_score(velocity, _WriteBuffer.buffer.length, variance);
    const topology = ActEngine.classify(actScore);
    _WriteBuffer.currentTopology.set(docKey, topology);
    ...
    const adaptiveThreshold = AensEngine.calculate_threshold(velocity, 0.5, _WriteBuffer.buffer.length, topologyWindow);
    let pvcAdjustment = 1;
    const existingDocWrites = _WriteBuffer.buffer.filter((b) => `${b.workspace}:${b.path}` === docKey);
    ...
    if (typeof globalThis.updateAensMetrics === "function") {
      globalThis.updateAensMetrics({
        lastThreshold: finalThreshold,
        lastVelocity: velocity,
        lastStability: stability,
        pvcSignal: pvcAdjustment < 1 ? "FAST-TRACK" : "SYNC-LOCKED",
        topology,
        actScore
      });
    }
  ...
  async scheduleFlush(threshold, ctx) {
    if (_WriteBuffer.buffer.length >= _WriteBuffer.bufferSize) {
      await this.flush(ctx);
      return;
    }
    if (_WriteBuffer.flushTimer) return;
    const timeSinceLastFlush = Date.now() - _WriteBuffer.lastFlush;
    const remainingTime = Math.max(0, threshold - timeSinceLastFlush);
    if (remainingTime === 0) {
      await this.flush(ctx);
    } else {
      _WriteBuffer.flushTimer = true;
      const flushAction = /* @__PURE__ */ __name(async () => {
        _WriteBuffer.flushTimer = null;
        await this.flush(ctx);
      }, "flushAction");
      if (ctx) {
  ...
  async flush(ctx) {
    if (_WriteBuffer.isProcessing || _WriteBuffer.buffer.length === 0) {
      return;
    }
    _WriteBuffer.isProcessing = true;
    try {
      while (_WriteBuffer.buffer.length > 0) {
        ...
        _WriteBuffer.metrics.totalBatches++;
        _WriteBuffer.metrics.totalEventsCoalesced += batch.length;
        _WriteBuffer.metrics.lastBatchSize = batch.length;
        await this.executeBatch(merged, ctx);
      }
    } catch (e) {
      _WriteBuffer.metrics.lastError = e.message;
      _WriteBuffer.metrics.lastFlushSuccess = false;
  ...
  mergeWrites(writes) {
    ...
    for (const [key, docWrites] of map.entries()) {
      ...
      try {
        ...
        _WriteBuffer.metrics.lastCompressionKeyCount = keyCount;
      } catch (e) {
  ...
  async executeBatch(operations, ctx) {
    ...
    try {
      ...
      _WriteBuffer.metrics.lastFlushSuccess = true;
    } catch (e) {
      _WriteBuffer.metrics.lastFlushSuccess = false;
      _WriteBuffer.metrics.lastError = e.message;
    ...
    const cache2 = new PredictiveCache(this.env);
    for (const op of operations) {
      if (ctx) {
        ctx.waitUntil(cache2.delete(`doc:${workspace}:${op.path}`));
        ctx.waitUntil(cache2.delete(`coll:${workspace}:${op.collection}:*`));
      } else {
        await cache2.delete(`doc:${workspace}:${op.path}`);
        await cache2.delete(`coll:${workspace}:${op.collection}:*`);
      }
    }
  }
};
...
globalThis.updateAensMetrics = (update) => {
  metrics.aens = { ...metrics.aens, ...update };
};
globalThis.recordHit = () => {
  metrics.cacheHits++;
};
globalThis.recordMiss = () => {
  metrics.cacheMisses++;
};
...
var security = new SecurityEngine(JSON.stringify(rulesConfig));
var corsHeaders = {
...
var rpcService = {
  async getDocument(req) {
    ...
    const doc = await cache2.get(`doc:${workspace}:${req.path}`, async () => {
  ...
  async listDocuments(req) {
    ...
    const docs = await cache2.get(cacheKey, async () => {
    ...
    return create(ListDocumentsResponseSchema, {
      documents: (docs || []).map((doc) => create(DocumentSchema, {
        path: doc.path,
        id: doc.id,
        workspaceId: doc.workspace_id,
        collectionName: doc.collection_name,
...
async function resolveDbId(workspace, env, ctx) {
  const now = Date.now();
  const mem = PROJECT_MEMORY_CACHE.get(workspace);
  if (mem && mem.expiry > now) return mem.id;
  let cached = await env.PROJECT_CACHE.get(`project:${workspace}:db`);
  if (!cached) {
...
async function initDatabase(env) {
  ...
  const checkResult = await env.DB.prepare("SELECT count(*) as count FROM sqlite_master WHERE type='table' AND name='documents'").first();
  if (checkResult && checkResult.count > 0) {
    const checkCols = await env.DB.prepare("SELECT sql FROM sqlite_master WHERE name = 'documents'").first();
    ...
    console.log("\u{1F680} INITIALIZING NEW DATABASE...");
  }
  await env.DB.batch([
  ...
  async handleRequest(request, env, ctx) {
    ...
    if (url.pathname === "/_status") {
      return new Response(JSON.stringify({
        ...
        metrics: {
          ...metrics,
          uptime: `${Math.floor((Date.now() - metrics.startTime) / 1e3)} s`,
    ...
    if (url.pathname === "/centrifugo-config") {
      ...
      const wsUrl = apiUrl.replace("https://", "wss://").replace("http://", "ws://").replace("/api", "/connection/websocket").split("?")[0];
      return Response.json({
        wsUrl,
        token: ""
        // anonymous access - add JWT here for auth if needed
      }, { headers: { ...corsHeaders } });
    }
    if (url.pathname === "/_research/buffer") {
      return Response.json({
        ...
        topology: Array.from(WriteBuffer.currentTopology || [])
      }, { headers: { ...corsHeaders } });
    }
    ...
    try {
      let collection = pathSegments[0] || null;
      let docId = pathSegments[1] || null;
    ...
    VALUES(?, ?, ?, 'admin', ?)
      ...
      if (url.pathname === "/auth/token" || url.pathname === "/documents/auth/token") {
        ...
        const authResult2 = await authenticateRequest(request, env, ctx);
        if (authResult2.error) return Response.json({ error: authResult2.error }, { status: 401, headers: corsHeaders });
        const token = await new SignJWT({
          userId: userId || authResult2.userId || "anonymous",
          workspaceId: authResult2.workspaceId,
          role: authResult2.role || "user"
        }).setProtectedHeader({ alg: "HS256" }).setExpirationTime("1w").sign(new TextEncoder().encode(env.TOKEN_SECRET || "my_32_char_secret_key_testing_123"));
        return Response.json({
          token,
          workspaceId: authResult2.workspaceId
        }, { headers: corsHeaders });
      ...
      if (pathSegments.length > 0) {
        ...
        let resolvedDbId2 = d1DatabaseId || await env.PROJECT_CACHE.get(`project:${workspace}: db`);
        console.log(`[Documents] Resolved DB ID: ${resolvedDbId2} `);
        if (!resolvedDbId2) {
          try {
            const project = await env.DB.prepare("SELECT d1_database_id FROM projects WHERE id = ?").bind(workspace).first();
            console.log(`[Documents] Project Lookup: `, project);
            if (project) {
              resolvedDbId2 = project.d1_database_id;
              ctx.waitUntil(env.PROJECT_CACHE.put(`project:${workspace}: db`, resolvedDbId2, { expirationTtl: 86400 }));
            }
          } catch (dbErr) {
        ...
        const dbId = resolvedDbId2 || "native";
        ...
        if (method === "POST" && collection === "batch") {
          ...
          const dbId2 = resolvedDbId2 || "native";
          for (const op of operations) {
            ...
            const currentDoc = await gateway2.query(dbId2, "SELECT version FROM documents WHERE path = ? AND workspace_id = ?", [path, workspaceId2]);
            ...
            if (!await security.canWrite(path, auth2, data)) {
    ...
    VALUES(?, ?, ?, ?, ?, ?, ?, ?, 0)
          ...
          try {
            const results = await gateway2.batch(dbId2, gatewayOps);
            const versions = [];
            ...
            for (let i = 0; i < publishPayloads.length; i++) {
              ...
              pub.data.doc.version = version;
              const fullPath = pub.data.path;
              if (pub.data.type === "DELETED") {
                ctx.waitUntil(cache2.delete(`doc:${workspaceId2}:${fullPath} `));
              } else {
                const formattedDoc = { id: pub.data.id, path: fullPath, data: pub.data.doc.data, version };
                ctx.waitUntil(cache2.set(`doc:${workspaceId2}:${fullPath} `, formattedDoc));
              }
              const collectionName = fullPath.split("/").slice(-2, -1)[0] || "";
              ctx.waitUntil(cache2.delete(`coll:${workspaceId2}:${collectionName}:* `));
          ...
          try {
            ...
            if (!await security.canWrite(fullDocPath, auth2, data)) {
            ...
            if (noCache) {
              const eventId = crypto.randomUUID();
              const eventRes = await gateway2.query(dbId, `INSERT INTO events (id, doc_id, workspace_id, event_type, payload) VALUES (?, ?, ?, ?, ?)`, [eventId, id, workspace, "SET", JSON.stringify(data)]);
              docVersion = eventRes.meta.last_row_id;
              await gateway2.query(dbId, `INSERT INTO documents (path, id, workspace_id, collection_name, parent_path, depth, data, version, user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?) ON CONFLICT(workspace_id, path) DO UPDATE SET data = excluded.data, version = excluded.version, updated_at = CURRENT_TIMESTAMP, deleted_at = NULL`, [fullDocPath, id, workspace, collection, parentPath2 || "", depth + 1, JSON.stringify(data), docVersion, userId || "anonymous"]);
            } else {
            ...
            const cache2 = new PredictiveCache(env);
            ctx.waitUntil(cache2.set(`doc:${workspace}:${fullDocPath}`, { id, path: fullDocPath, data, version: docVersion }));
          ...
          const dbId2 = resolvedDbId2 || "native";
          const res = await new D1Gateway(env).query(dbId2, "SELECT * FROM events WHERE workspace_id = ? AND version > ? ORDER BY version ASC LIMIT 1000", [workspace, sinceVersion]);
          ...
          if (cached) return Response.json(cached, { headers: { ...corsHeaders, "X-Cache": "HIT", "X-Internal-Latency": `${Date.now() - startTime}ms` } });
          const dbId2 = resolvedDbId2 || "native";
          const res = await new D1Gateway(env).query(dbId2, `SELECT * FROM documents WHERE workspace_id = ? AND path LIKE ?`, [workspace, targetPath ? `${targetPath}/%` : "%"]);
          ...
          const dbId2 = resolvedDbId2 || "native";
          const responseData = await cache2.get(cacheKey, async () => {
            const res = await new D1Gateway(env).query(dbId2, "SELECT * FROM documents WHERE collection_name = ? AND workspace_id = ? AND deleted_at IS NULL", [collection, workspace]);
            const docs = res.results.map((r) => ({ ...r, data: JSON.parse(r.data) }));
            for (const doc of docs) {
              ctx.waitUntil(cache2.set(`doc:${workspace}:${doc.path}`, doc, 300));
            }
            return docs;
          });
          ...
          const buffer = WriteBuffer.getInstance(env);
          await buffer.flush();
          if (!await security.canRead(fullDocPath, auth2)) {
            return new Response("Permission Denied", { status: 403, headers: { ...corsHeaders, "X-Internal-Latency": `${Date.now() - startTime}ms` } });
          }
          let doc;
          if (noCache) {
            const res = await new D1Gateway(env).query(dbId2, "SELECT * FROM documents WHERE path = ? AND workspace_id = ? AND deleted_at IS NULL", [fullDocPath, workspace]);
            if (res.results && res.results.length > 0) {
              const r = res.results[0];
              doc = { ...r, data: JSON.parse(r.data) };
            }
          } else {
            doc = await cache2.get(`doc:${workspace}:${fullDocPath}`, async () => {
              const res = await new D1Gateway(env).query(dbId2, "SELECT * FROM documents WHERE path = ? AND workspace_id = ? AND deleted_at IS NULL", [fullDocPath, workspace]);
          ...
          const isAllowed = await security.canWrite(fullPath, auth2, data);
          console.log(`[DEBUG] Security check for PUT ${fullPath}: ${isAllowed ? "ALLOWED" : "DENIED"}`);
          if (!isAllowed) {
            return new Response("Permission Denied (Security Rules)", { status: 403, headers: { ...corsHeaders, "X-Internal-Latency": `${Date.now() - startTime}ms` } });
          }
          if (ifMatch) {
            const currentDoc = await gateway2.query(dbId2, "SELECT version FROM documents WHERE path = ? AND workspace_id = ?", [fullPath, workspace]);
            const currentVersion = currentDoc.results?.[0]?.version;
          ...
          const eventId = crypto.randomUUID();
          const eventRes = await gateway2.query(dbId2, `INSERT INTO events (id, doc_id, workspace_id, event_type, payload) VALUES (?, ?, ?, ?, ?)`, [eventId, docId, workspace, "SET", JSON.stringify(data)]);
          const version = eventRes.meta.last_row_id;
          await gateway2.query(
            dbId2,
            `INSERT INTO documents (path, id, workspace_id, collection_name, parent_path, depth, data, version, user_id) 
                          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?) 
                          ON CONFLICT(workspace_id, path) DO UPDATE SET 
                          data = json_patch(CASE WHEN json_valid(data) THEN data ELSE '{}' END, json(excluded.data)), 
                          version = excluded.version, 
          ...
          const cache2 = new PredictiveCache(env);
          ctx.waitUntil(cache2.set(`doc:${workspace}:${fullPath}`, { id: docId, path: fullPath, data, version }));
          ctx.waitUntil(publishToCentrifugo(env, `_ws_${workspace}_global_cache`, {
            type: "CACHE_WARM",
          ...
          const dbId2 = resolvedDbId2 || "native";
          const fullPath = parentPath ? `${parentPath}/${collection}/${docId}` : `${collection}/${docId}`;
          const isAllowed = await security.canWrite(fullPath, auth2, patchData);
          ...
          return Response.json({ success: true, mode: "AENS-BUFFERED" }, {
            headers: {
              ...
              "X-Contention-Class": WriteBuffer.getTopology(workspace, fullPath),
              "X-Internal-Latency": `${Date.now() - startTime}ms`,
              "X-Cache": "MISS"
            }
          });
          ...
          const dbId2 = resolvedDbId2 || "native";
          const fullDocPath = parentPath ? `${parentPath}/${collection}/${docId}` : `${collection}/${docId}`;
          if (!await security.canWrite(fullDocPath, auth2, null)) {
            return new Response("Permission Denied (Security Rules)", { status: 403, headers: { ...corsHeaders, "X-Internal-Latency": `${Date.now() - startTime}ms` } });
          }
          await gateway2.query(dbId2, "UPDATE documents SET deleted_at = CURRENT_TIMESTAMP WHERE path = ? AND workspace_id = ?", [fullDocPath, workspace]);
          const cache2 = new PredictiveCache(env);
          ctx.waitUntil(cache2.delete(`doc:${workspace}:${fullDocPath}`));
          ctx.waitUntil(cache2.delete(`coll:${workspace}:${collection}:*`));
...
// .wrangler/tmp/bundle-M42mnj/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-M42mnj/middleware-loader.entry.ts
